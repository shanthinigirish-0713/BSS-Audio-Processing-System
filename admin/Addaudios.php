					...
					<!-- //breadcrumbs -->
					       <div class="agile-validation w3ls-validate agile_info_shadow">
								<div class="inline-form widget-shadow agile-widget-shadow">
									...
									<h2 class="w3_inner_tittle two">Audios:</h2>
									</div>
									<div class="form-body form-body-info">
										<form action="Add_action.php" method="post" enctype="multipart/form-data">
										   <!-- <div class="form-group">
											...
											<div class="form-group">
											    <input type="text" class="form-control" name="Singer" placeholder="Enter Singer Name" required="">
											</div>
											<div class="form-group has-feedback">
												<input type="text" class="form-control" name="Musician" placeholder="Enter Musician Name"required="">
											</div>-->
											<div class="form-group">
											...
											Upload Audio:
											<label>
											<input type="file" name="audio" id="audio"></label>
											</div>
											<div class="bottom">
