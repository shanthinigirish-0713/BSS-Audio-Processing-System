...
<div class="wthree_agile_admin_info">
		...
		<!-- /inner_content-->
				...
				<!--<a href="excel.php" id="btn" class="btn btn-danger">EXCEL</a>-->

									  <h2 class="w3_inner_tittle">Audios:</h2>
								...
								if($count>0)
								{
									?>
										...
										while($row=$res->fetch_assoc())
										{
											...
											<tr>
											<td><?php echo $i++;?></td>
											<td><?php echo $row["Audios"];?></td>
											<td><?php echo $row["category"];?></td>
											<td><a href="Edit.php?audio=<?php echo $row["Id"];?>">Edit</a></td>
											<td><a href="Dlt.php?UserId=<?php echo $row["Id"];?>"onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
