							...
							<ul class="gn-menu agile_menu_drop">
								...
								<li>
									...
									<ul class="gn-submenu">
										...
										<li class="mini_list_w3"><a href="Viewaudios.php"> <i class="fa fa-caret-right" aria-hidden="true"></i> View Audios</a></li>
									</ul>
								</li>
								<li>
					...
					<!-- //breadcrumbs -->
					       <div class="agile-validation w3ls-validate agile_info_shadow">
								<div class="inline-form widget-shadow agile-widget-shadow">
									...
									<h2 class="w3_inner_tittle two">Audio Details:</h2>
									</div>
									<div class="form-body form-body-info">
									<?php
									require("connection.php");
									$userid=$_REQUEST["audio"];
									...
									?>
										...
										<form action="Edit_action.php" method="post" enctype="multipart/form-data">
						                	<div class="form-group">
												<input type="hidden" class="form-control" name="UserId" placeholder="Enter your id" value="<?php echo $row['Id'];?>" required="">
											</div>
											...
											<!--<div class="form-group">
												<input type="text" class="form-control" name="Movie" placeholder="Enter Movie Name" value="<?php echo $row['MovieName'];?>" required="">
											</div>
											<div class="form-group">
											    <input type="text" class="form-control" name="Singer" placeholder="Enter Singer Name"value="<?php echo $row['SingerName'];?>" required="">
											</div>
											<div class="form-group has-feedback">
												<input type="text" class="form-control" name="Musician" placeholder="Enter Musician Name" value="<?php echo $row['MusicianName'];?>"required="">
											</div>
											<div class="form-group">
												<input type="text" class="form-control" name="lyricist" placeholder="Enter your Lyricist Name"value="<?php echo $row['LyricistName'];?>" required="">
											</div>				-->	
											<div class="form-group">
											Upload Audio:
											<label>
											
											<input type="file" name="audio"  id="audio"></label><br><audio controls><source src="<?php echo "Audios/". $row['Audios'];?>"></audio>
											</div>
											<div class="bottom">
...
<div class="copyrights">
	 <p>© 2022 Admin. All Rights Reserved | Design by  BSS Based On Audio Frequency </p>
</div>	
